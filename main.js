window.onload = function() {
     ...
     *      Hint: if ( question1.value.toLowerCase().trim() ... ) { ... }
     *      Reference: https://www.w3schools.com/jsref/prop_text_value.toLowerCase().trim().asp
     * 
     * > If the question1 input box is empty, then display the alert message "Please enter a value.toLowerCase().trim() for question 1" to the user
     *      Hint: alert("Please enter a value.toLowerCase().trim() for question 1");
     *      Reference: https://www.w3schools.com/jsref/met_win_alert.asp
     *  
     */
    question1.onblur = function() {
        if ( question1.value.toLowerCase().trim() == "" ) {
     ...
     *      OPTIONS:
     *      a. You could use dot notation to attach the event
     *      Hint: question1.onchange = function() { ... }
    ...
    question1.onchange = function() {
        ...
        if ( question1.value.toLowerCase().trim() == q1_choices[0].toLowerCase() ) {
        ...
        else if ( question1.value.toLowerCase().trim() == q1_choices[1].toLowerCase() ) {
            info.innerHTML = "Incorrect!";
            /**
             * TODO:
             * > Add the feedback clarifying information to the paragraph element
        ...
        else if ( question1.value.toLowerCase().trim() == q1_choices[2].toLowerCase() ) {
        ...
        else if ( question1.value.toLowerCase().trim() == q1_choices[3].toLowerCase() ) {
            info.innerHTML = "Incorrect!";
            /**
             * TODO:
             * > Add the feedback clarifying information to the paragraph element
    ...
    question2.onchange = function() {
        ...
        if (question2.value.toLowerCase().trim() == q2_choices[0].toLowerCase()) {
            info.style.color = "green";
            info.innerHTML = "Correct!";
            /**
             * TODO:
        ...
        else if (question2.value.toLowerCase().trim() == q2_choices[1].toLowerCase()   ) {
            info.innerHTML = "Incorrect!";
            /**
             * TODO:
             * > Add the feedback clarifying information to the paragraph element
        ...
        else if (question2.value.toLowerCase().trim() == q2_choices[2].toLowerCase()   ) {
            info.innerHTML = "Incorrect!";
            /**
             * TODO:
             * > Add the feedback clarifying information to the paragraph element
        ...
        else if (question2.value.toLowerCase().trim() == q2_choices[3].toLowerCase()    ) {
            info.innerHTML = "Incorrect!";
            /**
             * TODO:
             * > Add the feedback clarifying information to the paragraph element
        ...
        // then display "Incorrect!"
        else if ( q2_choices.indexOf(question2.value.toLowerCase()) == -1 ) {
            info.innerHTML = "No such option has been provided please enter the full name of the options listed out for you below the question. Have another go!";
        }
    ...
    question3.onchange = function() {
        ...
        if (question3.value.toLowerCase().trim() == q3_choices[0].toLowerCase() ) {
            info.style.color = "green";
            info.innerHTML = "Correct!";
            /**
             * TODO:
        ...
        else if (question3.value.toLowerCase().trim() == q3_choices[1].toLowerCase()    ) {
            info.innerHTML = "Incorrect!";
            /**
             * TODO:
             * > Add the feedback clarifying information to the paragraph element
        ...
        else if (question3.value.toLowerCase().trim() == q3_choices[2].toLowerCase()) {
            info.innerHTML = "Incorrect!";
            /**
             * TODO:
             * > Add the feedback clarifying information to the paragraph element
        ...
        else if (question3.value.toLowerCase().trim() == q3_choices[3].toLowerCase()) {
            info.innerHTML = "Incorrect!";
            /**
             * TODO:
             * > Add the feedback clarifying information to the paragraph element
        ...
        // else if the question3.value.toLowerCase().trim() is not in the list of choices
        // then display "Incorrect!"
        else if ( q3_choices.indexOf(question3.value.toLowerCase().trim()) == -1 ) {
            info.innerHTML += "No such option has been provided please enter the full name of the options listed out for you below the question. Have another go!";
        }
    ...
    question4.onchange = function() {
        ...
        // if the question4.value.toLowerCase().trim() is the first choice
        if ( question4.value.toLowerCase().trim() == q4_choices[0].toLowerCase()   ) {
            info.style.color = "green";
            info.innerHTML = "Correct!";
            /**
             * TODO:
        ...
        // else if the question4.value.toLowerCase().trim() is the second choice
        else if ( question4.value.toLowerCase().trim() == q4_choices[1].toLowerCase() ) {
            info.innerHTML = "Incorrect!";
            /**
             * TODO:
             * > Add the feedback clarifying information to the paragraph element
        ...
        // else if the question4.value.toLowerCase().trim() is the third choice
        else if ( question4.value.toLowerCase().trim() == q4_choices[2].toLowerCase()) {
            info.innerHTML = "Incorrect!";
            /**
             * TODO:
             * > Add the feedback clarifying information to the paragraph element
        ...
        // else if the question4.value.toLowerCase().trim() is the fourth choice
        else if ( question4.value.toLowerCase().trim() == q4_choices[3].toLowerCase()) {
            info.innerHTML = "Incorrect!";
            /**
             * TODO:
             * > Add the feedback clarifying information to the paragraph element
        ...
        // else if the question4.value.toLowerCase().trim() is not in the list of choices
        // then display "Incorrect!"
        else if ( q4_choices.indexOf(question4.value.toLowerCase().trim()) == -1 ) {
            info.innerHTML = "No such option has been provided please enter the full name of the options listed out for you below the question. Have another go!";
        }
    ...
    question5.onchange = function() {
        ...
        // if the question5.value.toLowerCase().trim() is the first choice
        if ( question5.value.toLowerCase().trim() == q5_choices[0].toLowerCase()    ) {
            info.style.color = "green";
            info.innerHTML = "Correct!";
            /**
             * TODO:
        ...
        // else if the question5.value.toLowerCase().trim() is the second choice
        else if (question5.value.toLowerCase().trim() == q5_choices[1].toLowerCase()) {
            info.innerHTML = "Incorrect!";
            /**
             * TODO:
             * > Add the feedback clarifying information to the paragraph element
        ...
        // else if the question5.value.toLowerCase().trim() is the third choice
        else if (question5.value.toLowerCase().trim() == q5_choices[2].toLowerCase()) {
            info.innerHTML = "Incorrect!";
            /**
             * TODO:
             * > Add the feedback clarifying information to the paragraph element
        ...
        // else if the question5.value.toLowerCase().trim() is the fourth choice
        else if (question5.value.toLowerCase().trim() == q5_choices[3].toLowerCase()) {
            info.innerHTML = "Incorrect!";
            /**
             * TODO:
             * > Add the feedback clarifying information to the paragraph element
             ...
             *      Reference: https://www.w3schools.com/jsref/jsref_operators.asp
             */
            info.innerHTML =  "=> United States is the fourth largest country in the world by total area, spanning 9,826,675 km2 (3,794,081 sq mi) and 6.7% of the Earth's total surface area.";
        } 
        // else if the question5.value.toLowerCase().trim() is not in the list of choices
        // then display "Incorrect!"
        else if ( q5_choices.indexOf(question5.value.toLowerCase().trim()) == -1 ) {
            info.innerHTML = "No such option has been provided please enter the full name of the options listed out for you below the question. Have another go!";
        }
    ...
    question6.onchange = function() {
        ...
        // if the question6.value.toLowerCase().trim() is the first choice
        if  (question6.value.toLowerCase().trim() == q6_choices[0].toLowerCase()){
            info.style.color = "green";
            info.innerHTML = "Correct!";
            /**
             * TODO:
        ...
        // else if the question6.value.toLowerCase().trim() is the second choice
        else if(question6.value.toLowerCase().trim() == q6_choices[1].toLowerCase()){
            info.innerHTML = "Incorrect!";
            /**
             * TODO:
             * > Add the feedback clarifying information to the paragraph element
        ...
        // else if the question6.value.toLowerCase().trim() is the third choice
        else if (question6.value.toLowerCase().trim() == q6_choices[3].toLowerCase()){
            info.innerHTML = "Incorrect!";
            /**
             * TODO:
             * > Add the feedback clarifying information to the paragraph element
        ...
        // else if the question6.value.toLowerCase().trim() is the fourth choice
        else if(question6.value.toLowerCase().trim() == q6_choices[3].toLowerCase())  {
            info.innerHTML = "Incorrect!";
            /**
             * TODO:
        ...
        // else if the question6.value.toLowerCase().trim() is not in the list of choices
        // then display "Incorrect!"
        else if ( q6_choices.indexOf(question6.value.toLowerCase().trim()) == -1 ) {
            info.innerHTML = "No such option has been provided please enter the full name of the options listed out for you below the question. Have another go!";
        }
    ...
    question7.onchange = function() {
        ...
        // if the question7.value.toLowerCase().trim() is the first choice
        if  (question7.value.toLowerCase().trim() == q7_choices[0].toLowerCase()){
            info.style.color = "green";
            info.innerHTML = "Correct!";
            /**
             * TODO:
        ...
        // else if the question7.value.toLowerCase().trim() is the second choice
        else if(question7.value.toLowerCase().trim() == q7_choices[1].toLowerCase())  {
            info.innerHTML = "Incorrect!";
            /**
             * TODO:
             * > Add the feedback clarifying information to the paragraph element
        ...
        // else if the question7.value.toLowerCase().trim() is the third choice
        else if(question7.value.toLowerCase().trim() == q7_choices[2].toLowerCase())  {
            info.innerHTML = "Incorrect!";
            /**
             * TODO:
             * > Add the feedback clarifying information to the paragraph element
        ...
        // else if the question7.value.toLowerCase().trim() is the fourth choice
        else if (question7.value.toLowerCase().trim() == q7_choices[3].toLowerCase())   {
            info.innerHTML = "Incorrect!";
            /**
             * TODO:
             * > Add the feedback clarifying information to the paragraph element
        ...
        // else if the question7.value.toLowerCase().trim() is not in the list of choices
        // then display "Incorrect!"
        else if ( q7_choices.indexOf(question7.value.toLowerCase().trim()) == -1 ) {
            info.innerHTML = "No such option has been provided please enter the full name of the options listed out for you below the question. Have another go!";
        }
    ...
    question8.onchange = function() {
        ...
        // if the question8.value.toLowerCase().trim() is the first choice
        if (question8.value.toLowerCase().trim() == q8_choices[0].toLowerCase())   {
            info.style.color = "green";
            info.innerHTML = "Correct!";
            /**
             * TODO:
        ...
        // else if the question8.value.toLowerCase().trim() is the second choice
        else if(question8.value.toLowerCase().trim() == q8_choices[1].toLowerCase())   {
            info.innerHTML = "Incorrect!";
            /**
             * TODO:
             * > Add the feedback clarifying information to the paragraph element
        ...
        // else if the question8.value.toLowerCase().trim() is the third choice
        else if(question8.value.toLowerCase().trim() == q8_choices[2].toLowerCase())    {
            info.innerHTML = "Incorrect!";
            /**
             * TODO:
             * > Add the feedback clarifying information to the paragraph element
        ...
        // else if the question8.value.toLowerCase().trim() is the fourth choice
        else if(question8.value.toLowerCase().trim() == q8_choices[3].toLowerCase())    {
            info.innerHTML = "Incorrect!";
            /**
             * TODO:
             * > Add the feedback clarifying information to the paragraph element
        ...
        // else if the question8.value.toLowerCase().trim() is not in the list of choices
        // then display "Incorrect!"
        else if ( q8_choices.indexOf(question8.value.toLowerCase().trim()) == -1 ) {
            info.innerHTML = "No such option has been provided please enter the full name of the options listed out for you below the question. Have another go!";
        }
    ...
    question9.onchange = function() {
        ...
        // if the question9.value.toLowerCase().trim() is the first choice
        if (question9.value.toLowerCase().trim() == q9_choices[0].toLowerCase()) {
            info.style.color = "green";
            info.innerHTML = "Correct!";
            /**
             * TODO:
        ...
        // else if the question9.value.toLowerCase().trim() is the second choice
        else if (question9.value.toLowerCase().trim() == q9_choices[1].toLowerCase()    ) {
            info.innerHTML = "Incorrect!";
            /**
             * TODO:
             * > Add the feedback clarifying information to the paragraph element
        ...
        // else if the question9.value.toLowerCase().trim() is the third choice
        else if ( question9.value.toLowerCase().trim() == q9_choices[2].toLowerCase()   ) {
            info.innerHTML = "Incorrect!";
            /**
             * TODO:
             * > Add the feedback clarifying information to the paragraph element
        ...
        // else if the question9.value.toLowerCase().trim() is the fourth choice
        else if (question9.value.toLowerCase().trim() == q9_choices[3].toLowerCase()   ) {
            info.innerHTML = "Incorrect!";
            /**
             * TODO:
             * > Add the feedback clarifying information to the paragraph element
        ...
        // else if the question9.value.toLowerCase().trim() is not in the list of choices
        // then display "Incorrect!"
        else if ( q9_choices.indexOf(question9.value.toLowerCase().trim()) == -1 ) {
            info.innerHTML = "No such option has been provided please enter the full name of the options listed out for you below the question. Have another go!";
        }
    ...
    question10.onchange = function() {
        ...
        // if the question10.value.toLowerCase().trim() is the first choice
        if ( question10.value.toLowerCase().trim() == q10_choices[0].toLowerCase()  ) {
            info.style.color = "green";
            info.innerHTML = "Correct!";
            /**
             * TODO:
        ...
        // else if the question10.value.toLowerCase().trim() is the second choice
        else if (question10.value.toLowerCase().trim() == q10_choices[1].toLowerCase()   ) {
            info.innerHTML = "Incorrect!";
            /**
             * TODO:
             * > Add the feedback clarifying information to the paragraph element
        ...
        // else if the question10.value.toLowerCase().trim() is the third choice
        else if (question10.value.toLowerCase().trim() == q10_choices[2].toLowerCase()) {
            info.innerHTML = "Incorrect!";
            /**
             * TODO:
             * > Add the feedback clarifying information to the paragraph element
        ...
        // else if the question10.value.toLowerCase().trim() is the fourth choice
        else if (question10.value.toLowerCase().trim() == q10_choices[3].toLowerCase()) {
            info.innerHTML = "Incorrect!";
            /**
             * TODO:
             * > Add the feedback clarifying information to the paragraph element
        ...
        // else if the question10.value.toLowerCase().trim() is not in the list of choices
        // then display "Incorrect!"
        else if ( q10_choices.indexOf(question10.value.toLowerCase().trim()) == -1 ) {
            info.innerHTML = "No such option has been provided please enter the full name of the options listed out for you below the question. Have another go!";
        }
